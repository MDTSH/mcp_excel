...
def test_forward_points_curve_basic():
    ...
    # Create curve parameters (single-sided)
    args = {
...
def test_standard_tenors_calculation(curve, cal, spot_date):
    """Test standard tenor calculation"""
    print("\n" + "=" * 60)
    print("Standard Tenor Forward Points and Exchange Rate Calculation")
    print("=" * 60)
...
def test_broken_date_calculation(curve, cal):
    """Test non-standard tenor date calculation"""
    print("=" * 60)
    print("Non-standard Tenor Date Forward Points Calculation")
    print("=" * 60)
